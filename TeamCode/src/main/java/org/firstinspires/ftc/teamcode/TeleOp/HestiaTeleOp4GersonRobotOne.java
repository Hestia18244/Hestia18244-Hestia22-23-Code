...
@TeleOp (name = "HestiaTeleOp4GersonRobotOne")

public class HestiaTeleOp4GersonRobotOne extends OpMode {
...
double viperTurn = .45*(gamepad2.right_stick_y);
double viperSlide = gamepad2.left_stick_y;
